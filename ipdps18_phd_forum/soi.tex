...
go to talking about smaller machines that have a different set of challenges.} 
\vbnote{I am proposing using multiple machines concurrently when one single
